			...
			<div class="bg-color" >
				<nav class="navbar navbar-default navbar-fixed-top">
					<div class="container">
						...
						<div class="alert alert-success" style="color: #fcfcfc;background-color:transparent;">{{ Session::get('demosuccess') }} <i class="fa fa-close" style="opacity: 0.60;" aria-hidden="true"></i></div>
						@endif
					</div>					
				</nav>
