						...
						<div class="col-md-12">
							...
							<div class="collapse navbar-collapse navbar-right" id="myNavbar">
								<ul class="nav navbar-nav">
									...
									<li class=""><a href="#doctor-team">Doctors-Team</a></li>
			...
			<div class="container">
				<div class=" row">
					...
					<div class="col-md-4 col-sm-5">
						We Care for you 24x7 <i class="fa fa-heartbeat" style="color:red" aria-hidden="true"></i>
						<p class="text-right text-primary"><i>— Healthcare</i></p>
					</div>
					<div class="col-md-2"></div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4 col-sm-4">
						<h3>Contact Info</h3>
						<div class="space"></div>
						<p><i class="fa fa-map-marker fa-fw pull-left fa-2x"></i>sunderbaug colony<br>
						dapodi, pune</p>
						<div class="space"></div>
						<p><i class="fa fa-envelope-o fa-fw pull-left fa-2x"></i>saurabh24p@gmail.com</p>
						<div class="space"></div>
						<p><i class="fa fa-phone fa-fw pull-left fa-2x"></i>+91 8793829287</p>
					</div>
